...
public class Setting extends JFrame {
	...
	GoodsDTO dto = null;
	String id = null;
//	ShoppingMall shop = ShoppingMall.getinstance();
	...
	private void createtb() {
		...
		JButton shopB = new JButton("쇼핑몰가기");
		south_south.add(shopB);
		...
		shopB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < txtfield.length; i++) {
					in[i] = txtfield[i].getText();
					txtfield[i].setText("");
					new ShoppingMall(null);
				}

			}
		});

		JButton orderallB = new JButton("회원 주문내역");
